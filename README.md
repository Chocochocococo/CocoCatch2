...
## 版本更新資訊
2026/8/17 公開0.0.6.7版本：
- ChatGPT全分支模式可匯出SillyTavern格式（包含分支）

2026/8/12 公開0.0.6.5版本：
- 修正ChatGPT更新後匯出訊息不全的問題
- ChatGPT新增「全分支」模式，可直接匯出聊天室包含分支的完整訊息，僅作為前述功能失效時的備用選項

2026/5/5 公開0.0.6.2版本：
- 修正ChatGPT更新後找不到匯出訊息的問題

2025/12/4 公開0.0.6.1版本：
- 支援Grok聊天室
- 修正Chrome版本截圖用戶訊息不分行的問題
- 修正Clauden勾選框錯位與匯出模型型號的問題
